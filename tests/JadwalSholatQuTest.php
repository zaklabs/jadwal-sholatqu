...
namespace Zaklabs\JadwalShalat\Test;

use Zaklabs\JadwalShalat\JadwalShalatQu;
use PHPUnit\Framework\TestCase;

class JadwalShalatQuTest extends TestCase
{
    ...
    public function testGetKabupatenKota()
    {
        ...
        $this->assertTrue(count($kabkot) > 1);
    ...
    public function testGetJadwalShalat()
    {
        ...
        $provinsi = $jadwalShalat->getProvinsi();
        $kabkot = $jadwalShalat->getKabupatenKota($provinsi[0]['value']);
        $jadwal = $jadwalShalat->getJadwalShalat($provinsi[0]['value'], $kabkot[0]['value'], 1, 2023);
